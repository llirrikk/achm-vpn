...
unix_server_wg_init = "sudo /home/debian/unix-server-wg-init.sh {wg_address_mask} {wg_port} {wg_interface} {wg_client_allowed_ips} {wg_base_directory}"
unix_server_wg_create_client_config = "sudo /home/debian/unix-server-wg-create-client-config.sh {wg_client_config_path} {wg_client_address} {wg_client_dns} {wg_server_endpoint_host} {wg_server_endpoint_port} {wg_client_allowed_ips} {persistent_keepalive}"
...
def configure_wireguard_server(
    ...
    with SSHConnection(
        ...
        ssh.send_file(
            ...
            "/home/debian/unix-server-wg-create-client-config.sh",
        )
        ssh.send("chmod +x /home/debian/unix-server-wg-create-client-config.sh")
